...
function NextButton({active = true, onClick}: {active?: any, onClick: any}) {
    return (
        <div onClick={onClick} className={`${active ? 'cursor-pointer group' : 'cursor-default grayscale opacity-60'} w-[100px] flex flex-col gap-5`}>
