...
function FullRaportPreview({formData, setFormData, step, setStep}: {formData: any, setFormData: any, step?: any, setStep?: any}) {
        ...
        <div className='flex flex-col gap-0 pb-10'>
            ...
            <div className='mt-10'>
                <div className='flex flex-row items-center gap-2.5'>
                    <p>Raport jest dostępny pod adresem: <a href='#' className='underline'>https://domena-kalkulatora.pl/wynik/28mp6</a></p>
                    <Image 
                        onClick={() => {copyToClipboard('https://domena-kalkulatora.pl/wynik/28mp6'); toast.success('Poprawnie skopiowano link do schowka')}} 
                        src={copy.src} 
                        alt="copy icon" 
                        height={20} 
                        width={20} 
            ...
            <div className='mt-20'>
                <p className='text-[36px] md:text-[50px] font-[600] max-w-[800px] leading-[110%]'>Szacunkowe zapotrzebowanie na moc i energię cieplną</p>
                <div className='flex flex-col lg:flex-row mt-10 gap-5 lg:gap-16 items-start justify-start'>
                    <div className='flex flex-col w-full lg:w-auto text-white bg-[#FF4510] items-start justify-center py-2.5 px-5'>
                        ...
                        <div className='flex flex-row items-center gap-2.5'>
                            <span className='text-[30px] font-[700]'>11,7kW</span>
                    ...
                    <div className='flex w-full lg:w-auto flex-col text-white bg-[#FF4510] items-start justify-center py-2.5 px-5'>
                        ...
                        <div className='flex flex-row items-center gap-2.5'>
                            <span className='text-[30px] font-[700]'>~29 178kWh = 105GJ</span>
                            <span className='font-[400] text-[20px]'>(C.O. + CWU)</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='mt-20'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10 mt-10'>
                    ...
                    <div>
                        ...
                        <p className='pt-2.5'>Przez inżynierów zwana Ciepłą Wodą Użytkową (CWU).</p>
                        <p className='pt-5'>Oblicz zapotrzebowanie energii na podgrzewanie CWU</p>
                        <p className='font-[700] pt-1'>{formData.count_need_energy_cwu ? 'Tak' : 'Nie'}</p>
                        ...
                        <p className='font-[700] mt-2.5'>{!formData.hot_water_steroid_foto && !formData.how_water_steroid_kolektor ? 'brak' : `${formData.hot_water_steroid_foto ? 'Instalacja fotowoltaiczna' : ''}${formData.how_water_steroid_kolektor && formData.hot_water_steroid_foto ? ', Kolektory słoneczne' : formData.how_water_steroid_kolektor ? 'Kolektory słoneczne' : ''}`}</p>
                    </div>
                </div>
            </div>
            ...
            <div className='mt-20'>
                ...
                <div className='grid grid-cols-1 mt-7 lg:grid-cols-4 gap-5 lg:gap-10'>
            ...
            <div className='flex flex-row gap-7 mt-14'>
                <div className='uppercase font-[700] h-[50px] flex items-center justify-center px-6 border border-[#FF4510] text-[#FF4510] hover:bg-[#FF4510] hover:text-white cursor-pointer transition-all duration-200'>
                    <span>wydrukuj</span>
                </div>
                <div className='uppercase font-[700] h-[50px] flex items-center justify-center px-6 border border-[#FF4510] text-[#FF4510] hover:bg-[#FF4510] hover:text-white cursor-pointer transition-all duration-200'>
