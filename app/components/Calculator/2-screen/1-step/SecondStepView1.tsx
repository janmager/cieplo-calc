...
function SecondStepView1({formData, setFormData, errors, setErrors}: {formData: any, setFormData: any, errors: any, setErrors: any}) {
    ...
    useEffect(() => {
        if(formData.building_outline.indexOf('Nieregularny') >= 0){
            setShowSidebarPowierzchniaZabudowy(true)
        }
        else if(formData.building_outline.indexOf('prostokątny') >= 0 && formData.building_outline_sizes.indexOf('zabudowy') >= 0){
            setShowSidebarPowierzchniaZabudowy(true)
        }
        else{
    ...
    if(formData.building_type != 'Mieszkanie') return (
        <div className='flex flex-col gap-14 w-full'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
                <div>
                    <CustomLabel label='Określ kształt budynku:' />
                ...
                <div className='h-full flex flex-col gap-5 items-start w-full'>
                        ...
                        <div className='flex flex-1 flex-col'>
                            ...
                            <div className='flex gap-10 flex-row items-center justify-start'>
                                ...
                                <div className='mt-[-25px]'>
                                    ...
                                    <div className='relative h-[100px] mt-[-5px] w-[100px] flex items-center justify-center'>
                    ...
                    <div className={`${showSidebarPowierzchniaZabudowy ? 'flex' : 'hidden'} w-full flex-row gap-5 items-start bg-[#F8F8F8] p-[20px]`}>
                        <div>
                            <Image src={info.src} height={24} width={24} alt="Info icon" />
                        </div>
                        <div className='flex flex-1 flex-col'>
                            <b>Co to jest powierzchnia zabudowy?</b>
                            <p className='text-[14px] mt-2.5'>To powierzchnia gruntu zajmowana przez budynek. Znajdziesz ją w projekcie budynku pod tą samą nazwą. Jeśli nie dysponujesz tą informacją, podaj wymiary zewnętrzne budynku.</p>
