    ...
    try{
        ...
        const add = await prisma.raport.create({
            data: {
                ...
                rule_privacy_policy: raport.rule_privacy_policy,
                rule_expert_gree: raport.rule_expert_gree,
                rule_mail_raport: raport.rule_mail_raport,
                rule_other_company_contact: raport.rule_other_company_contact,
