                        ...
                        <div class="content" style="box-sizing: border-box; display: block; margin: 0 auto; max-width: 600px; padding: 0;">
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background: #ffffff; border: 1px solid #eaebed; border-radius: 16px; width: 100%; height: 100%;" width="100%">
                                <tr>
                                    ...
                                    <a style="background: #FF4510; margin-bottom: 20px; width: fit; text-decoration: none; font-size: 17px; color: white; padding: 15px 30px; display: block; border-radius: 5px;" href="${`https://gree.ivn-works.com/kalkulator-wynik?hash=${raportId}`}">Pobierz Raport</a>
                                    </td>
                                </tr>
                            </table>
                            <div class="footer" style="clear: both; padding-top: 24px; text-align: center; width: 100%;">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                                    <tr>
                                    <td class="content-block powered-by" style="font-family: Helvetica, sans-serif; vertical-align: top; color: #9a9ea6; font-size: 14px; padding-top: 20px; text-align: center;" valign="top" align="center">
                                        &copy; 2025 GreeCalc
                                    </td>
                                    </tr>
                                </table>
